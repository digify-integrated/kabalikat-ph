...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const config = {
        forms: [
            {
                ...
                rules: {
                    ...
                    submitHandler: async (form) => {
                        ...
                        formData.append('kitchen_route_id', ctx2.detailId ?? '');
                        ...
                        try {
                            const response = await fetch('/kitchen-route/save', {
                                method: 'POST',
                                body: formData,
                            });

                            if (!response.ok) {
                                throw new Error(`Save kitchen route failed with status: ${response.status}`);
                            }
        ...
        details: [
            {
                url: '/kitchen-route/fetch-details',
                formSelector: '#kitchen_route_form',
        ...
        delete: {
            trigger: '#delete-kitchen-route',
            url: '/kitchen-route/delete',
            swalTitle: 'Confirm Kitchen Route Deletion',
            swalText: 'Are you sure you want to delete this kitchen route?',
