...
document.addEventListener('DOMContentLoaded', () => {
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                    ...
                    <div class="card-header border-0 pt-6 pb-3">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h3 class="fw-bold mb-0">${register.shop_register_name}</h3>
                                    <div class="text-muted fs-7 mt-1">
                                        Not initialized
                                    </div>
                                </div>
                            </div>
                            <span class="badge badge-light-warning fw-semibold px-3 py-2">READY</span>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-4 pb-3">
                        <div class="text-center py-6">
                            ...
                            <h4 class="fw-bold text-gray-800 mb-2">No register session yet</h4>
            ...
            <div class="col-md-6">
                    ...
                    <div class="card-header border-0 pt-6 pb-4">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h3 class="fw-bold mb-1">${register.shop_register_name}</h3>
                            ...
                            <span class="badge badge-light-success fw-bold px-4 py-2">OPEN</span>
                        </div>
                    </div>
                    <div class="px-6 mb-5">
                        <div class="row g-3">
                            ...
                            <div class="timeline">
                                <div class="timeline-item align-items-center mb-7">
                                    ...
                                    <div class="timeline-content m-0">
                                        <span class="fs-7 text-gray-500 d-block">Register Opened</span>
                                        <span class="fs-6 fw-bold text-gray-800">${register.open_time}</span>
                                    </div>
                                </div>
                                <div class="timeline-item align-items-center">
                                    ...
                                    <div class="timeline-content m-0">
                                        <span class="fs-7 text-gray-500 d-block">Currently Active</span>
                                        <span class="fs-6 fw-bold text-gray-800">Awaiting closing</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                        <div class="d-flex gap-3">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#register-modal" data-shop-register-id="${register.id}" data-session="close" class="btn btn-warning fw-bold w-50 py-3 rounded-3 shop-register">
                                Close Register
                            </a>

                            <a href="${register.link}" class="btn btn-primary fw-bold w-50 py-3 rounded-3">
                                View Register
                            </a>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                    ...
                    <div class="card-header border-0 pt-6 pb-4">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            ...
                            <span class="badge badge-light-danger fw-bold px-4 py-2">CLOSED</span>
                        </div>
                    </div>
                        ...
                        <div class="bg-light rounded-4 p-5">
                            ...
                            <div class="timeline">
                                ...
                                <div class="timeline-item align-items-center">
                                    ...
                                    <div class="timeline-content m-0">
                                        <span class="fs-7 text-gray-500 d-block">Register Closed</span>
                                        <span class="fs-6 fw-bold text-gray-800">${register.close_time}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">                    
                    <div class="card-body text-center py-10">
                        ...
                        <h3 class="fw-bold text-gray-800 mb-2">No Shop Register Assigned</h3>
    ...
    const setRegisterModalMode = (session) => {
        ...
        document.querySelector('#register-modal h2').innerText = isOpening ? 'Cash Count' : 'Cash Count';

        document.querySelector('#register-modal .text-muted.fs-7').innerText = isOpening? 'Enter denominations to compute opening cash' : 'Enter denominations to compute closing cash';

        const badge = document.querySelector('#register-modal .register-badge');

        badge.className = isOpening ? 'badge badge-light-success px-4 py-3 fs-7 fw-bold register-badge' : 'badge badge-light-danger px-4 py-3 fs-7 fw-bold register-badge';

        badge.innerText = isOpening ? 'Register Opening' : 'Register Closing';

        document.querySelector('#register-modal .total-label').innerText = isOpening ? 'Opening Cash Total' : 'Closing Cash Total';

        const btn = document.querySelector('#register-modal button[type="submit"]');

        btn.className = isOpening ? 'btn btn-success w-100 py-4 fw-bold rounded-3' : 'btn btn-danger w-100 py-4 fw-bold rounded-3';

        btn.innerText = isOpening ? 'Open Register' : 'Close Register';
    };
