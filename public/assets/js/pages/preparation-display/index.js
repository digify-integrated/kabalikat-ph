    ...
    const generateKitchenRoutes = async (url, otherData = {}) => {
        try {
            ...
            if (data?.success) {
                ...
                const container =
                    document.getElementById('kitchen-route-container');
