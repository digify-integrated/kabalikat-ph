        ...
        <div class="row align-items-center justify-content-center h-100 g-0">
            <div class="col-xl-7 col-lg-7 col-md-7 col-12">
                <div class="text-center px-2">
                    ...
                    <span class="d-block fs-4 text-primary fw-semibold">Page Not Found</span>
                    <p class="error-text mb-0">404</p>
                    <p class="fs-5 fw-normal mb-0">The page you are trying to access does not exist or may have been moved.</p>
                </div>
            </div>
        </div>
    </div>
