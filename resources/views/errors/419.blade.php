        ...
        <div class="row align-items-center justify-content-center h-100 g-0">
            <div class="col-xl-7 col-lg-7 col-md-7 col-12">
                <div class="text-center px-2">
                    ...
                    <span class="d-block fs-4 text-primary fw-semibold">Session Expired</span>
                    <p class="error-text mb-0">419</p>
                    <p class="fs-5 fw-normal mb-0">Your session has expired. Please refresh the page or log in again.</p>
                </div>
            </div>
        </div>
    </div>
