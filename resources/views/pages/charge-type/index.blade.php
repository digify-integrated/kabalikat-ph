            ...
            <div class="card-toolbar">
                ...
                <div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5">
                            <div class="mb-5">
                                <label class="form-label fs-6 fw-semibold" for="filter_by_value_type">Filter By Value Type:</label>
                                <select id="filter_by_value_type" class="form-select" data-control="select2" data-allow-clear="false">
                                    <option value="">--</option>
