    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    @if(($deletePermission ?? 0) > 0 || ($exportPermission ?? 0) > 0)
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-city-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            data-kt-menu="true">
                ...
                <div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5">
                            <div class="mb-5">
                                <label class="form-label fs-6 fw-semibold" for="filter_by_state">Filter By State:</label>
                            ...
                            <div class="mb-5">
                                <label class="form-label fs-6 fw-semibold" for="filter_by_country">Filter By Country:</label>
        ...
        <div class="card-body pt-9">
            <div class="table-responsive">
                <table class="table align-middle cursor-pointer table-row-dashed fs-6 gy-5" id="city-table">
                    <thead>
