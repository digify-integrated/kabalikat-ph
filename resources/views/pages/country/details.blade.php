            ...
            <div class="card mb-10">
                ...
                <div class="card-body border-top p-9">
                    <form id="country_form" method="post" action="#" novalidate>
                        ...
                        <div class="fv-row mb-4">
                            ...
                            <input type="text" class="form-control" id="country_name" name="country_name" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                        </div>
                    </form>
                </div>
                ...
                @if($canWrite)
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="submit" class="btn btn-primary" form="country_form" id="submit-data">
                            Save Changes
                        </button>
                    </div>
                @endif
