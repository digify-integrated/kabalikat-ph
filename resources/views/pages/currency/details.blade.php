            ...
            <div class="card mb-10">
                        ...
                        <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-3 row-cols-lg-3">
                            <div class="col">
                                <div class="fv-row mb-4">
                                    ...
                                    <input type="text" class="form-control" id="currency_name" name="currency_name" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                </div>
                            </div>
                            <div class="col">
                                <div class="fv-row mb-4">
                                    ...
                                    <input type="text" class="form-control" id="symbol" name="symbol" maxlength="10" autocomplete="off" @disabled(!$canWrite)>
                                </div>
                            </div>
                            <div class="col">
                                <div class="fv-row mb-4">
                ...
                @if($canWrite)
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="submit" class="btn btn-primary" form="currency_form" id="submit-data">
                            Save Changes
                        </button>
                    </div>
                @endif
