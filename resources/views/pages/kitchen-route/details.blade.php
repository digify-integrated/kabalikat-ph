            ...
            <div class="card mb-10">
                <div class="card-header border-0">
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Kitchen Route Details</h3>
                    </div>
                    @if($canDelete)
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="z-index: 107; position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-60px, 539px);" data-popper-placement="bottom-end">
                            <div class="menu-item px-3">
                                <a href="javascript:void(0);" class="menu-link px-3" id="delete-kitchen-route">
                                    Delete
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body border-top p-9">
                    <form id="kitchen_route_form" method="post" action="#" novalidate>
                        ...
                        <div class="fv-row mb-4">
                            ...
                            <input type="text" class="form-control" id="kitchen_route_name" name="kitchen_route_name" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="fv-row mb-4">
                                    ...
                                    <input type="number" class="form-control" id="printer_port" name="printer_port" min="0" step="1" @disabled(!$canWrite)>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                @if($canWrite)
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="submit" class="btn btn-primary" form="kitchen_route_form" id="submit-data">
                            Save Changes
                        </button>
                    </div>
                @endif
