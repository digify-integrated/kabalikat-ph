...
@section('content')    
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#navigation_menu_route_tab" aria-selected="false" role="tab">Route</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#navigation_menu_permission_tab" aria-selected="false" role="tab">Permission</a>
            </li>
        ...
        <div class="tab-content">
            <div class="tab-content" id="user_account_tab_content">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body border-top p-9">
                            <form id="navigation_menu_form" method="post" action="#" novalidate>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6" for="navigation_menu_name">
                                        Display Name
                                    </label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="navigation_menu_name" name="navigation_menu_name" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                    </div>
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6" for="app_id">
                                        App
                                    </label>
                                    <div class="col-lg-9">
                                        <select id="app_id" name="app_id" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite)>
                                            <option>--</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6" for="parent_id">
                                        Parent Menu
                                    </label>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6" for="navigation_menu_icon">
                                        Icon
                                    </label>
                                    <div class="col-lg-9">
                                       <select id="navigation_menu_icon" name="navigation_menu_icon" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite)>
                                            <option value="">--</option>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6" for="order_sequence">
                                        Order Sequence
                                    </label>
                                    <div class="col-lg-9">
                                        <input type="number" class="form-control" id="order_sequence" name="order_sequence" min="0" max="1000" @disabled(!$canWrite)>
                                    </div>
                                </div>

                                <div class="row">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6" for="table_name">
                                        Database Table
                                    </label>
                                    <div class="col-lg-9">
                                        <select id="table_name" name="table_name" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite)>
                                            <option>--</option>
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="navigation_menu_route_tab" role="tabpanel">
                    <div class="card mb-10">
                        <div class="card-header border-0">
                            <div class="card-title m-0">
                                <h3 class="fw-bold m-0">Route Details</h3>
                            </div>
                        </div>
                        <div class="card-body border-top p-9">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="index_view_file" name="index_view_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="index_js_file" name="index_js_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="new_view_file" name="new_view_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="new_js_file" name="new_js_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="details_view_file" name="details_view_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="details_js_file" name="details_js_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="import_view_file" name="import_view_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" id="import_js_file" name="import_js_file" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="tab-pane fade" id="navigation_menu_permission_tab" role="tabpanel">
                    <div class="card">
