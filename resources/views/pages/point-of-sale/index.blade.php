                ...
                <div class="modal-body p-5">
                    <form id="register_form" method="post" action="#">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="ms-auto">
                                <span class="badge badge-light-success px-4 py-3 fs-7 fw-bold register-badge">Register Opening</span>
                            </div>
                            ...
                            <div class="col-xl-8">
                                <div class="card border-0 shadow-sm rounded-4 mb-6 overflow-hidden">
                                    <div class="card-header border-0 bg-light-primary min-h-60px">
                                        <div class="card-title">
                                            <h3 class="fw-bold fs-5 mb-0">Bills</h3>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="border border-gray-200 rounded-4 p-4 bg-light h-100 denomination-card">
                                                        <div class="d-flex align-items-center mb-4">
                                                            ...
                                                            <div class="ms-auto">
                                                                <span class="badge badge-light-primary fs-8">Bill</span>
                                                            </div>
                                                        </div>

                                                        <div class="row g-3">
                                                            <div class="col-6">
                                                                <label class="fs-8 fw-semibold text-muted mb-2">Quantity</label>

                                                                <input type="number" id="open_{{ $id }}" name="open_{{ $id }}" class="form-control form-control-solid text-center fw-bold qty-input" data-denomination="{{ str_replace(',', '', $label) }}" min="0" step="1" inputmode="numeric" placeholder="0" />
                                                            </div>

                                                            <div class="col-6">
                                                                <label class="fs-8 fw-semibold text-muted mb-2">Subtotal</label>

                                                                <div class="form-control form-control-solid d-flex align-items-center justify-content-end fw-bolder text-primary">
                                                                    ₱ 
                                                                    <span class="subtotal" id="subtotal_{{ $id }}">0.00</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                                    <div class="card-header border-0 bg-light-warning min-h-60px">
                                        <div class="card-title">
                                            <h3 class="fw-bold fs-5 mb-0">Coins</h3>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-4 col-6">
                                                    <div class="border border-gray-200 rounded-4 p-4 bg-light h-100 denomination-card">
                                                        <div class="d-flex align-items-center mb-3">
                                                            ...
                                                            <div class="ms-auto">
                                                                <span class="badge badge-light-warning fs-8">Coin</span>
                                                            </div>
                                                        </div>

                                                        <label class="fs-8 fw-semibold text-muted mb-2">Quantity</label>

                                                        <input type="number" id="open_{{ $id }}" name="open_{{ $id }}" class="form-control form-control-solid text-center fw-bold qty-input mb-3" data-denomination="{{ str_replace(',', '', $label) }}" min="0" step="1" inputmode="numeric" placeholder="0" />
                                                        ...
                                                        <div class="text-end">
                                                            ...
                                                            <div class="fw-bolder text-primary fs-5">
                                                                ₱ <span class="subtotal" id="subtotal_{{ $id }}">
                                                                    0.00
                                                                </span>
                                                            </div>
                                                        </div>
                                ...
                                <div class="position-sticky" style="top: 20px;">
                                    <div class="card border-0 shadow-sm rounded-4 mb-5 overflow-hidden">
                                        <div class="bg-success px-6 py-6">
                                            ...
                                            <div class="fw-bolder text-white lh-1" style="font-size: 44px;">
                                    ...
                                    <div class="card border-0 shadow-sm rounded-4 mb-5">
                                        <div class="card-body">
                                            <label class="fw-semibold fs-6 mb-3" for="remarks">Remarks</label>

                                            <textarea class="form-control form-control-solid" id="remarks" name="remarks" rows="6" maxlength="1000" placeholder="Optional remarks..."></textarea>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-success w-100 py-4 fw-bold rounded-4 fs-5" id="submit-data">
                                        Open Register
                                    </button>
