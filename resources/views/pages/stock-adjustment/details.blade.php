                ...
                <div class="card-body border-top p-9">
                    <form id="stock_adjustment_form" method="post" action="#" novalidate>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <select id="stock_level_id" name="stock_level_id" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite || $stockAdjustment->stock_adjustment_status !== 'Draft')>
                                    <option>--</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <select id="adjustment_type" name="adjustment_type" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite || $stockAdjustment->stock_adjustment_status !== 'Draft')>
                                    <option value="">--</option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <input type="number" class="form-control" id="quantity" name="quantity" min="0.01" step="0.01" @disabled(!$canWrite || $stockAdjustment->stock_adjustment_status !== 'Draft')>
                            </div>
                        </div>
