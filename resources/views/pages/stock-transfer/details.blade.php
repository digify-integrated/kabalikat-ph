                ...
                <div class="card-body border-top p-9">
                    <form id="stock_transfer_form" method="post" action="#" novalidate>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <select id="stock_level_from_id" name="stock_level_from_id" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite || $stockTransfer->stock_transfer_status !== 'Draft')>
                                    <option>--</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <select id="stock_level_to_id" name="stock_level_to_id" class="form-select" data-control="select2" data-allow-clear="false" @disabled(!$canWrite || $stockTransfer->stock_transfer_status !== 'Draft')>
                                    <option>--</option>
                                </select>
                            </div>
                        </div>
