...
@section('content')    
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#system_action_permission_tab" aria-selected="false" role="tab">Permission</a>
            </li>
        ...
        <div class="tab-content">
            <div class="tab-content" id="user_account_tab_content">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body border-top p-9">
                            <form id="system_action_form" method="post" action="#" novalidate>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6" for="system_action_name">
                                        Display Name
                                    </label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="system_action_name" name="system_action_name" maxlength="100" autocomplete="off" @disabled(!$canWrite)>
                                    </div>
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6" for="system_action_description">
                                        Description
                                    </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control" id="system_action_description" name="system_action_description" maxlength="200" rows="3" @disabled(!$canWrite)></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="tab-pane fade" id="system_action_permission_tab" role="tabpanel">
                    <div class="card">
