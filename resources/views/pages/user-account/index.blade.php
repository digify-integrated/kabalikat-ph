    ...
    <div class="card">
                        ...
                        <div class="px-7 py-5">
                            <div class="mb-5">
                                ...
                                <select id="filter_by_user_status" class="form-select" data-control="select2" data-allow-clear="false">
                                    <option value="">--</option>
                                    <option value="ActiveYes">Active</option>
        ...
        <div class="card-body pt-9">
            <div class="table-responsive">
                <table class="table align-middle cursor-pointer table-row-dashed fs-6 gy-5" id="users-table">
                    <thead>
