                    ...
                    <div class="row switcher-style gx-0">
                        <div class="col-4">
                            <div class="form-check switch-select">
                                <label class="form-check-label" for="switcher-light-theme">Ligh</label>
                    ...
                    <div class="row switcher-style gx-0 pb-2 gy-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check switch-select">
                                ...
                                <input class="form-check-input" type="radio" name="sidemenu-layout-styles" id="switcher-double-menu" checked>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabindex="0">
                <div>
                    ...
                    <div class="theme-colors">
                        ...
                        <div class="d-flex switcher-style pb-2">
                            <div class="form-check switch-select me-3">
                                <input class="form-check-input color-input color-white" data-bs-toggle="tooltip" data-bs-placement="top" title="Light Header" type="radio" name="header-colors" id="switcher-header-light">
                            </div>
                            <div class="form-check switch-select me-3">
                            ...
                            <div class="form-check switch-select me-3">
                                <input class="form-check-input color-input color-transparent" data-bs-toggle="tooltip" data-bs-placement="top" title="Transparent Header" type="radio" name="header-colors" id="switcher-header-transparent" checked>
                            </div>
                        </div>
                    ...
                    <div class="menu-image mb-3">
                        ...
                        <div class="d-flex flex-wrap align-items-center switcher-style">
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img1" type="radio" name="menu-background" id="switcher-bg-img">
                                <div class="bg-img-container">
                                    <img src="{{ asset('assets/images/menu-bg-images/bg-img1.jpg') }}" alt="bg-1">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img2" type="radio" name="menu-background" id="switcher-bg-img1">
                                <div class="bg-img-container">
                                    <img src="{{ asset('assets/images/menu-bg-images/bg-img2.jpg') }}" alt="bg-2">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img3" type="radio" name="menu-background" id="switcher-bg-img2">
                                <div class="bg-img-container">
                                    <img src="{{ asset('assets/images/menu-bg-images/bg-img3.jpg') }}" alt="bg-3">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img4" type="radio" name="menu-background" id="switcher-bg-img3">
                                <div class="bg-img-container">
                                    <img src="{{ asset('assets/images/menu-bg-images/bg-img4.jpg') }}" alt="bg-4">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img5" type="radio" name="menu-background" id="switcher-bg-img4">
                                <div class="bg-img-container">
                                    <img src="{{ asset('assets/images/menu-bg-images/bg-img5.jpg') }}" alt="bg-5">
                                </div>
                            </div>
                        </div>
                    </div>
